...
router.post('/', upload.single('company_logo'), asyncHandler(userController.createUser));
...
router.put('/update/:id', upload.single('company_logo'), userController.updateUser);
